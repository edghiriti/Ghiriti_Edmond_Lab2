...
namespace Ghiriti_Edmond_Lab2.Models
{
    public class BookCategoriesPageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ghiriti_Edmond_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ghiriti_Edmond_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
